...
function filterByVolume() {
    //get the text from the inputs
    let minInputValue = document.getElementById("min-volume").value;
    let maxInputValue = document.getElementById("max-volume").value;
    //cast to number
...
const volumeSearchBtn = document.getElementById("volume-search-button");
...
const top10Btn = document.getElementById("top-10-button");
...
function sortByChosenKey() {
    let checkBox = document.getElementById("sort-ascending");
    let reverseOrder = checkBox.checked == true;
    let selectOption = document.querySelector("#sort-by");
